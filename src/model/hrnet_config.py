...
_C.MODEL.EXTRA.FINAL_CONV_KERNEL = 3
...
_C.MODEL.EXTRA.STAGE2.NUM_CHANNELS = [CHANNELS, CHANNELS*2]
...
_C.MODEL.EXTRA.STAGE3.NUM_CHANNELS = [CHANNELS, CHANNELS*2, CHANNELS*4]
...
_C.MODEL.EXTRA.STAGE4.NUM_CHANNELS = [CHANNELS, CHANNELS*2, CHANNELS*4, CHANNELS*8]
